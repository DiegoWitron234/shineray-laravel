    ...
    <div id="myCarousel" class="carousel slide mb-6" data-bs-ride="carousel" data-bs-interval="4000" data-bs-pause="false" data-aos="fade-in">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="container">
                    <div class="carousel-caption text-start" data-aos="fade-up" data-aos-duration="1000">
                        <h1 class="text-shadow">Contacto.</h1>
                        <p class="opacity-75 text-shadow">Contáctanos para pedir tu automóvil.</p>
                        <p><a class="btn btn-lg btn-primary" href="{{ route('contacto') }}">Contactar</a></p>
                    </div>
                </div>
            </div>
